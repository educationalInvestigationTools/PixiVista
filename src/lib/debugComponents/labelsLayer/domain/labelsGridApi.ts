...
import { LabelsGridLayer } from '@/debugComponents/labelsLayer/infrastructure/rendering/labelsGridLayer.ts'
...
} from '@/debugComponents/labelsLayer/application/commands/changeCellTextCommand'
import {
    ChangeAllCellsTextCommandEventLabel,
    type ChangeAllCellsTextCommand,
} from '@/debugComponents/labelsLayer/application/commands/changeAllCellsTextCommand'
