import { SignalSourceBuildData, type OneDimSignalRaw, type SerializedOutput, type SignalSource, type SignalSourceBuildDataSerializer, type SignalSourceFactory } from "@/plotComponent/application/interfaces/signalSource"
...
export class MockSignalSourceConstructor extends SignalSourceBuildData {
    ...
    constructor(samplingFrequency: number, totalSeconds: number, label: string) {
...
export class MockSignalSourceFactory implements SignalSourceFactory<
    MockSignalSourceConstructor,
    MockSignalSource
> {
